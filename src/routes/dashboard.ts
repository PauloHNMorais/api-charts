...
export async function dashboardRoutes(fastify: FastifyInstance) {
  fastify.get('/dashboard/sales', async (req, res) => {
    ...
    const data = await GetDashboardSalesUseCase.execute(
      params.startDate,
      params.endDate
    );
    return data;
  ...
  fastify.get('/dashboard/clientsAverageTicket', async (req, res) => {
    ...
    const data = await GetDashboardClientsAverageTicketUseCase.execute(
      params.startDate,
      params.endDate
    );
    return data;
  ...
  fastify.get('/dashboard/salesByCategory', async (req, res) => {
    ...
    const data = await GetDashboardSalesByCategoryUseCase.execute(
      params.startDate,
      params.endDate
    );
    return data;
  ...
  fastify.get('/dashboard/salesBySaler', async (req, res) => {
    ...
    const data = await GetDashboardSalesBySalerUseCase.execute(
      params.startDate,
      params.endDate
    );
    return data;
  ...
  fastify.get('/dashboard/salesByCategoryAndAge', async (req, res) => {
    ...
    const data = await GetDashboardSalesByCategoryAndAgeUseCase.execute(
      params.startDate,
      params.endDate
    );
    return data;
